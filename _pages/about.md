...
<div class="project-item">
  ...
  <ul>
    <li><strong>数据科学全流程：</strong>负责从数据获取、清洗和特征工程，到模型训练、评估及生产级部署的完整工作流；完成日均百万级用户浏览数据的清洗、维度拆解、分类汇总与结构化处理，为借贷业务运营和成本控制提供数据支撑。</li>
    <li><strong>文本语义分析：</strong>使用 Word2Vec 对特定领域文本库进行向量化表征，支持相似文本检索，为相关业务场景提供语义分析能力。</li>
    <li><strong>知识库建设：</strong>主导团队知识库的设计与搭建，系统化沉淀技术文档和业务流程，提升新人入职、信息检索及知识复用效率。</li>
  </ul>
</div>
