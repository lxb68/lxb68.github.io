...
<div class="project-item">
  ...
  <ul>
    <li><strong>数据科学全流程：</strong>精通从数据获取、清洗、特征工程到模型训练、评估及生产级部署的完整数据科学工作流。完成了日均百万级用户浏览数据清洗、维度拆解，分类汇总与结构化处理，为风控模型训练和业务决策提供数据支撑。</li>
    <li><strong>文本语义分析：</strong>文本分类与语义分析：应用Word2Vec模型对特殊文本库进行词向量建模，支持相似文本检索功能，服务于内容审核与风控场景。</li>
    <li><strong>知识库建设：</strong>知识库体系构建：主导设计并搭建团队知识库系统，系统化沉淀技术文档与流程，显著提升新人入职效率及团队成员信息检索与复用能力。</li>
  </ul>
</div>
